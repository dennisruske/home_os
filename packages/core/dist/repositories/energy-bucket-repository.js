...
exports.EnergyBucketRepository = void 0;
exports.createEnergyBucketRepository = createEnergyBucketRepository;
/**
...
class EnergyBucketRepository {
     ...
     */
    async getBucketsForRange(from, to) {
        try {
     ...
     */
    async getFirstReadingBefore(timestamp) {
        try {
     ...
     * @returns Promise resolving to EnergyReading or null if not found
     */
    async getFirstReadingAfter(timestamp) {
        try {
            const reading = await this.prisma.energyReading.findFirst({
                where: {
                    timestamp: {
     ...
     */
    async getLatestBucketTimestamp() {
        try {
     ...
     */
    async getHourlyBucketsForRange(from, to) {
        try {
     ...
     */
    async getDailyBucketsForRange(from, to) {
        try {
