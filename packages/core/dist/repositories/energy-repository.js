...
exports.createEnergyRepository = createEnergyRepository;
/**
...
class EnergyRepository {
     ...
     */
    async insertEnergyReading(data) {
        if (!data.timestamp) {
     ...
     */
    async getEnergyReadings(limit = 100, offset = 0, from, to) {
        try {
            const where = {};
            if (from || to) {
                where.timestamp = {};
     ...
     * @returns Promise resolving to array of EnergyReading
     */
    async getEnergyReadingsForRange(from, to) {
        try {
            const readings = await this.prisma.energyReading.findMany({
                where: {
                    timestamp: {
     ...
     */
    async updateEnergySettingsEndDate(settingsId, endDate) {
        try {
     ...
     */
    async createEnergySettings(producingPrice, consumingPeriods, startDate, endDate = null) {
        try {
     ...
     */
    async findActiveEnergySettings(timestamp) {
        try {
 ...
 */
function createEnergyRepository(prisma) {
